...
public interface FilesAPI {
     ...
     * @param nameFilterRegexp Only returns entries whose name matches this regular expression
     *                         (default: .*)
     * @param typeFilterRegexp Only returns entries whose media type matches this regular expression
     *                         (default: .*)
     * @param listPublic       True to retrieve the public entries only (the shared files), False
     ...
     * @param nameFilterRegexp If retrieving a folder, include only entries whose name matches this
     *                         regexp
     * @param typeFilterRegexp If retrieving a folder, include only entries whose media type matches
     *                         this regexp
