...
public class RegistryUtils {
	 ...
	 * @throws RegistryException Thrown if a registry error occurs
	 */
	public UserRegistry getChrootUserRegistry(String userName, String chroot) throws RegistryException {
	 ...
	 */
	public static void authorizeEveryone(String resPath, UserRegistry registry, String... permissions) throws RegistryException, UserStoreException {
	 ...
	 * @throws UserStoreException Thrown if a user store error occurs
	 */
	public static void denyEveryone(String resPath, UserRegistry registry, String... permissions) throws RegistryException, UserStoreException {
	 ...
	 * @throws UserStoreException Thrown if a user store error occurs
	 */
	public static void clearEveryone(String resPath, UserRegistry registry, String... permissions) throws RegistryException, UserStoreException {
	 ...
	 * @throws UserStoreException Thrown if a user store error occurs
	 */
	public static boolean isEveryoneAuthorized(String resPath, UserRegistry registry, String... permissions) throws RegistryException, UserStoreException {
	 ...
	 * @throws UserStoreException Thrown if a user store error occurs
	 */
	public static void authorizeRole(String roleName, String resPath, UserRegistry registry, String... permissions) throws RegistryException, UserStoreException {
        UserRealm userRealm = registry.getUserRealm();
        AuthorizationManager authManager = userRealm.getAuthorizationManager();
	 ...
	 * @throws UserStoreException Thrown if a user store error occurs
	 */
	public static void denyRole(String roleName, String resPath, UserRegistry registry, String... permissions) throws RegistryException, UserStoreException {
        UserRealm userRealm = registry.getUserRealm();
        AuthorizationManager authManager = userRealm.getAuthorizationManager();
	 ...
	 * @throws UserStoreException Thrown if a user store error occurs
	 */
	public static void clearRole(String roleName, String resPath, UserRegistry registry, String... permissions) throws RegistryException, UserStoreException {
        UserRealm userRealm = registry.getUserRealm();
        AuthorizationManager authManager = userRealm.getAuthorizationManager();
	 ...
	 * @throws UserStoreException Thrown if a user store error occurs
	 */
	public static boolean isAuthorized(String resPath, UserRegistry registry, String... permissions) throws RegistryException, UserStoreException {
		UserRealm userRealm = registry.getUserRealm();
		AuthorizationManager authManager = userRealm.getAuthorizationManager();
