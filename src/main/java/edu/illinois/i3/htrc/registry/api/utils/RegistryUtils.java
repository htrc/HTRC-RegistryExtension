...
public class RegistryUtils {
     ...
     */
    public static void authorizeEveryone(String resPath, UserRegistry registry,
     ...
     * @throws UserStoreException Thrown if a user store error occurs
     */
    public static boolean isEveryoneAuthorized(String resPath, UserRegistry registry,
            String... permissions) throws RegistryException, UserStoreException {
     ...
     * @throws UserStoreException Thrown if a user store error occurs
     */
    public static void authorizeRole(String roleName, String resPath, UserRegistry registry,
            String... permissions) throws RegistryException, UserStoreException {
        UserRealm userRealm = registry.getUserRealm();
        AuthorizationManager authManager = userRealm.getAuthorizationManager();
     ...
     * @throws UserStoreException Thrown if a user store error occurs
     */
    public static void denyRole(String roleName, String resPath, UserRegistry registry,
            String... permissions) throws RegistryException, UserStoreException {
        UserRealm userRealm = registry.getUserRealm();
        AuthorizationManager authManager = userRealm.getAuthorizationManager();
     ...
     * @throws UserStoreException Thrown if a user store error occurs
     */
    public static void clearRole(String roleName, String resPath, UserRegistry registry,
            String... permissions) throws RegistryException, UserStoreException {
        UserRealm userRealm = registry.getUserRealm();
        AuthorizationManager authManager = userRealm.getAuthorizationManager();
