...
public class WorksetsAPIImpl implements WorksetsAPI {
        ...
        try {
            ...
            if (registry.resourceExists(resPath)) {
                return Response.status(Status.CONFLICT)
                        .entity("Workset " + worksetName
                                + " already exists. Must use PUT if an update is intended")
            ...
            try {
                ...
                workset.setMetadata(WorksetUtils
                        .updateResourceCommunityMeta(resource, workset.getMetadata(), registry,
                                _registryUtils));
     ...
     */
    private List<Workset> getUserWorksets(Collection worksetCollection, UserRegistry registry)
